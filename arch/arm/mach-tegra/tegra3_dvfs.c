...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",	1, 1, KHZ,		  1, 267000, 304000, 380000, 416000, 484000, 484000, 484000, 484000),
	CORE_DVFS("mpe",	1, 1, KHZ, 		  1, 267000, 304000, 380000, 416000, 484000, 484000, 484000, 484000),
	CORE_DVFS("2d",		1, 1, KHZ, 		  1, 267000, 304000, 380000, 416000, 484000, 484000, 484000, 484000),
	CORE_DVFS("epp",	1, 1, KHZ, 		  1, 267000, 304000, 380000, 416000, 484000, 484000, 484000, 484000),
	CORE_DVFS("3d",		1, 1, KHZ, 		  1, 267000, 304000, 380000, 416000, 484000, 484000, 484000, 484000),
	CORE_DVFS("3d2",	1, 1, KHZ, 		  1, 267000, 304000, 380000, 416000, 484000, 484000, 484000, 484000),
	CORE_DVFS("se",		1, 1, KHZ, 		  1, 267000, 304000, 380000, 416000, 484000, 484000, 484000, 484000),
